...
<head>
    ...
    <title>Little Fast Food | Food Details</title>
...
<tr>
<th style="padding-left:10px;">Order Number#</th> 
<td><?php echo $row['Ordernumber'];?></td>   
<th style="padding-left:10px;">Order Date/Time</th>
...
echo $status;
 ...
 ?> (<a href="javascript:void(0);" onClick="popUpWindow('trackorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Track order"><i class="flaticon-transport"></i> Bill</a>)</td>   
</tr>
<tr>
    <th colspan="4" style="text-align:center;color:blue; font-size:20px;  padding-top:10px; padding-bottom:10px;" >Delivery Address</th>
</tr>
<tr>
<th style="padding-left:10px;">Flat No / Building No.:</th>
<td><?php echo $row['Flatnobuldngno']?></td> 
<th style="padding-left:10px;">Street Name:</th>
...
<th style="padding-left:10px;">Landmark:</th>
<td><?php echo $row['Landmark']?></td>    
</tr>

<tr>
<th style="padding-left:10px;">City :</th>
