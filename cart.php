...
<td><a href="cart.php?delid=<?php echo $row['frid'];?>" onclick="return confirm('Do you really want to delete?');";><i class="fas fa-edit" aria-hidden="true" title="Delete this food item"></i><a/></span>
    <a href="cart.php?delid=<?php echo $row['frid'];?>" onclick="return confirm('Do you really want to delete?');";><i class="fa fa-trash" aria-hidden="true" title="Delete this food item"></i><a/></span></td>
</tr>
...
<tr>
    <td colspan="3">
        <button type="submit" class="btn btn-danger" name="placeorder">pay now</button>
        <?php
