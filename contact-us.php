...
<head>
    ...
    <title>Little Fast Food | Contact us</title>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Phone +91 8128546505</p>
                                                <p itemprop="description">Phone +91 7984294281</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">Vesu,Surat,Gujarat,India.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4">
                                            <div class="contact-info-box">
                                                ...
                                                <p itemprop="description">abc@gmail.com</p>
                                                <p itemprop="description">xyz@gmail.com</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
